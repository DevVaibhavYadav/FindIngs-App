...
public class FavoriteManager {
    ...
    /**
     * {@link Intent#getAction()} for broadcasting clearing all favorites
     */
    ...
    /**
     * {@link Intent#getAction()} for broadcasting adding favorites
     */
    public static final String ACTION_ADD = FavoriteManager.class.getName() + ".ACTION_ADD";
    /**
     * {@link Intent#getAction()} for broadcasting removing favorites
     */
     ...
     * @see #remove(Context, Set)
     * @see #clear(Context, String)
     */
